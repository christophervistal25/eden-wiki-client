<template>
  <div>
    <div
      class="pagination__parent ml-64 bg-white px-4 py-3 flex items-center justify-between border-t border-gray-200 sm:px-6"
    >
