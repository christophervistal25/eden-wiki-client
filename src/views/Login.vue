<template>
  <section class="absolute w-full top-0">
    <div
      class="absolute top-0 w-full h-screen bg-cover bg-gray-900"
      style="
        background-image: url('https://res.cloudinary.com/dfm6cr1l9/image/upload/v1605350249/eden/cool-background_xn2kmk.svg');
        background-size: 100%;
      ...
      <div class="flex content-center items-center justify-center h-full">
        <div class="w-full lg:w-4/12 px-4 pt-32">
          <div
            ...
            class="bg-red-100 border text-red-700 px-4 py-3 rounded relative mb-3"
            role="alert"
          >
