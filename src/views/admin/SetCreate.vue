<template>
      ...
      <div class="h-screen w-screen flex overflow-hidden select-none">
        ...
        >
          ...
          <div class="flex">
            ...
            >
              <h3
                class="flex flex-col px-5 py-1 text-2xl font-semibold dark:text-gray-300"
              >
  ...
  <div>
    ...
    >
      <div class="relative w-screen my-6 mx-auto text-sm p-20">
        <!--content-->
        <div
