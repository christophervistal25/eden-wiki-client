...
export default {
  ...
  methods: {
    getCategory() {
      ...
      axios.get(`admin/category/edit/${categoryId}`).then((response) => {
    ...
    updateCategorySubmit() {
      ...
      if (!this.category.type && !content.innerHTML) {
      ...
      if (this.errors.length === 0) {
        ...
        axios
          ...
          .then(() => {
            swal("Good job!", `Successfully update a category`, "success");
          });
      }
    },
  },
